...
*/
    ...
    public class Maths
    {
        ...
        /// is greater than 0.
        /// </exception>
        /// See <see cref="Maths.Add(double, double)"/> to add doubles.
        /// <seealso cref="Maths.Subtract(int, int)"/>
        /// <seealso cref="Maths.Multiply(int, int)"/>
        /// <seealso cref="Maths.Divide(int, int)"/>
        ...
        /// See <see cref="Maths.Add(int, int)"/> to add integers.
        /// <seealso cref="Maths.Subtract(double, double)"/>
        /// <seealso cref="Maths.Multiply(double, double)"/>
        /// <seealso cref="Maths.Divide(double, double)"/>
        ...
        /// </code>
        /// </example>
        /// See <see cref="Maths.Subtract(double, double)"/> to subtract doubles.
        /// <seealso cref="Maths.Add(int, int)"/>
        /// <seealso cref="Maths.Multiply(int, int)"/>
        /// <seealso cref="Maths.Divide(int, int)"/>
        /// <param name="a">An integer.</param>
        /// <param name="b">An integer.</param>
        ...
        /// </code>
        /// </example>
        /// See <see cref="Maths.Subtract(int, int)"/> to subtract integers.
        /// <seealso cref="Maths.Add(double, double)"/>
        /// <seealso cref="Maths.Multiply(double, double)"/>
        /// <seealso cref="Maths.Divide(double, double)"/>
        /// <param name="a">A double precision number.</param>
        /// <param name="b">A double precision number.</param>
        ...
        /// </code>
        /// </example>
        /// See <see cref="Maths.Multiply(double, double)"/> to multiply doubles.
        /// <seealso cref="Maths.Add(int, int)"/>
        /// <seealso cref="Maths.Subtract(int, int)"/>
        /// <seealso cref="Maths.Divide(int, int)"/>
        /// <param name="a">An integer.</param>
        ...
        /// </code>
        /// </example>
        /// See <see cref="Maths.Multiply(int, int)"/> to multiply integers.
        /// <seealso cref="Maths.Add(double, double)"/>
        /// <seealso cref="Maths.Subtract(double, double)"/>
        /// <seealso cref="Maths.Divide(double, double)"/>
        /// <param name="a">A double precision number.</param>
        ...
        /// </exception>
        /// See <see cref="Maths.Divide(double, double)"/> to divide doubles.
        /// <seealso cref="Maths.Add(int, int)"/>
        /// <seealso cref="Maths.Subtract(int, int)"/>
        /// <seealso cref="Maths.Multiply(int, int)"/>
        ...
        /// Thrown when <paramref name="b"/> is equal to 0.
        /// </exception>
        /// See <see cref="Maths.Divide(int, int)"/> to divide integers.
        /// <seealso cref="Maths.Add(double, double)"/>
        /// <seealso cref="Maths.Subtract(double, double)"/>
        /// <seealso cref="Maths.Multiply(double, double)"/>
